...
| `/project/:id` | ProjectDetail | 项目详情（4大功能标签） |
...
当前整体进度：**47.3%** (35/74 项完成)

| 模块 | 进度 | 说明 |
|------|------|------|
| P0 - 架构与核心 | 100% | Store + Types + Data 分层完成 |
| P0 - 核心流程 | 79% | 场景/角色/物品管理基本完成，剩余编辑功能 |
| P1 - Dashboard | 42% | 项目列表、新建功能完成 |
| P2 - 认证与首页 | 50% | 登录/注册 Mock 完成，Header 用户显示待做 |
| P3 - 辅助功能 | 27% | 导出/分享/批量删除待做 |
| P4 - 高级功能 | 0% | 图片改创规划中 |
